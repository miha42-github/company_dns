...
class FalshCmd(cmd.Cmd):
    ...
    def do_getsummary (self, query):
        all_companies = self.controller.getAllSummary(query)
        printer (all_companies)
    ...
    def do_getdetails (self, cik):
        all_companies = self.controller.getCompanyDetails(cik)
        printer (all_companies)
    ...
    def do_getciks (self, cik):
        all_companies = self.controller.getAllCIKs(cik)
        printer (all_companies)
